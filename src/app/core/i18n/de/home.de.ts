export const deHomeTexts = {
  homeHeroBadge: 'Premium Recommerce Plattform',
  homeHeroTitle: 'Kaufen und verkaufen mit Vertrauen.',
  homeHeroDescription:
    'Selorya verbindet hochwertiges Design, sicheren Handel und ein modernes Secondhand-Erlebnis für Deutschland.',
  homeHeroExploreAction: 'Anzeigen entdecken',
  homeHeroSellAction: 'Artikel verkaufen',
  homeHeroPanelLabel: 'Schneller Einstieg',
  homeHeroPanelTitle: 'Finde besondere Produkte schneller.',
  homeHeroPanelDescription:
    'Entdecke aktuelle Anzeigen, vergleiche Preise und starte direkt mit deinem nächsten Kauf oder Verkauf.',
  homeListingsEyebrow: 'Neue Anzeigen',
  homeListingsTitle: 'Direkt entdecken',
  homeListingsViewAll: 'Alle anzeigen',
  homeListingsLoadingTitle: 'Anzeigen werden geladen',
  homeListingsLoadingDescription: 'Einen Moment bitte. Wir bereiten die neuesten Produkte vor.',
  homeListingsEmptyTitle: 'Noch keine Anzeigen',
