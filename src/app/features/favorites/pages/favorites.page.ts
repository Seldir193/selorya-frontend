...
export class FavoritesPage {
  ...
  readonly sellerIcon = '/assets/icons/favorites/favorite-seller.svg';
  ...
  readonly sortDropdownOptions = computed(() => {
    ...
    return [
      { value: 'saved_desc', label: this.text('favorites.sort.recentlySaved') },
      { value: 'price_asc', label: this.text('favorites.sort.priceLowToHigh') },
      { value: 'price_desc', label: this.text('favorites.sort.priceHighToLow') },
      { value: 'title_asc', label: this.text('favorites.sort.titleAsc') },
      { value: 'title_desc', label: this.text('favorites.sort.titleDesc') },
    ];
  });
